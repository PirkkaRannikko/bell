...
internals.schema = Joi.object({
    ...
    clientAssertion: Joi.string().when('provider.protocol', { is: 'oauth2', otherwise: Joi.forbidden() }),
    clientAssertionType: Joi.string().when('provider.protocol', { is: 'oauth2', otherwise: Joi.forbidden() }),
    cookie: Joi.string(),
